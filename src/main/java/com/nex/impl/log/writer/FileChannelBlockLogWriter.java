 ...
 * @author xu.zx
 */
public class FileChannelBlockLogWriter implements LogWriter {

  private final File file;

  private final FileChannel fileChannel;

  public FileChannelBlockLogWriter(File file) throws FileNotFoundException {
    this(file, true);
  }

  public FileChannelBlockLogWriter(File file, boolean append) throws FileNotFoundException {
